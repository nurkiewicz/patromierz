define(["require", "exports", "ag-grid-community", "google-charts"], function (require, exports, ag_grid_community_1, google_charts_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    google_charts_1.google.charts.load('current', { packages: ['corechart', 'line', 'bar'], language: 'pl' });
    const explorer = {
    ...
    function drawMulti(profileNames, column, id, format) {
        google_charts_1.google.charts.setOnLoadCallback(() => {
            var dt = new google_charts_1.google.visualization.DataTable();
            dt.addColumn('date', '');
            ...
            var chart = new google_charts_1.google.visualization.LineChart(document.getElementById(id));
    ...
    function drawHorizontal(data, id) {
        google_charts_1.google.charts.setOnLoadCallback(() => {
            ...
            var materialChart = new google_charts_1.google.charts.Bar(document.getElementById(id));
            materialChart.draw(google_charts_1.google.visualization.arrayToDataTable(data), {
                bars: 'horizontal',
                legend: 'none',
                hAxis: {
                    format: 'currency'
    ...
    function makeTable(data) {
        ...
        new ag_grid_community_1.Grid(document.getElementById("table"), gridOptions);
