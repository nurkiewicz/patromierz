...
<script type="text/javascript">
    window.onload = () => {
            drawHorizontal([["Radio Nowy Świat", -2751], ["Uwaga Naukowy Bełkot", -1072], ["Dajcie nam głos!", -1000], ["Profesor Matczak", -780], ["SciFun", -664], ["życie warte jest rozmowy", -580], ["Ryszard Chojnowski", -525], ["Fundacja Wzajemnie Pomocni", -520], ["KidsAlert", -380], ["Cash", -340], ["NIEKOCHANE.PL", 400], ["br. Piotr Kwiatek", 410], ["YouMyGod", 426], ["ŻÓŁTE NAPISY", 440], ["Radio Naukowe - podcast Karoliny Głowackiej", 605], ["Fundacja dla Szczeniąt Judyta", 610], ["Dariusz Rosiak", 620], ["Zupa na Głównym", 970], ["Rynek Krowoderski", 1070], ["Dział Zagraniczny", 4085]], 'largest_changes');
            ...
            setTimeout(() => {
                drawMulti(
                    ['outriders', 'przezswiatnafazie', 'marekczyz', 'michalmarszal', 'globstory', 'VirtualDream', 'TERENWIZJA', 'motoambulans', 'darwin', 'sekielski', 'LukaszRybarskiYES', 'wolskiowojnie', 'pmm', 'UsłyszećNaCzas', 'historiarealna', 'planetaabstrakcja', 'zyciewartejestrozmowy', 'madamemonday', 'lifeonwheelz'],
