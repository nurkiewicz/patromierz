...
<script type="text/javascript">
    window.onload = () => {
            ...
            setTimeout(() => {
                drawMulti(
                    ['DariuszRosiak','dzialzagraniczny','DIOZ','langustanapalmie','dlr','karolinakp','Podcastwojennehistorie','marcinzielinski','radionaukowe','wszewko','Gadowski','sekielski','accantus','palhajstv','Vlogcasha','rockserwisfm','Zmierzchu','poglebiarka','brzmienie-swiata','UsłyszećNaCzas'], 
