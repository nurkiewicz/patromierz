...
<script type="text/javascript">
    window.onload = () => {
            drawHorizontal([["Nie wiem, ale się dowiem", -965], ["Tetrycy", -635], ["Podcast Wojenne Historie", -625], ["Podkast amerykański", -510], ["Adrian Dzierżenga", -500], ["Centrum Aktywizmu Klimatycznego &#34;Gniazdo&#34; w Warszawie", -500], ["Historia Realna - Piotr Zychowicz", -480], ["Tytus Chmielewski", -390], ["EWA WĄSIKOWSKA-TOMCZYŃSKA", -390], ["Joanna Flis", -385], ["Radio Naukowe - podcast Karoliny Głowackiej", 349], ["Fundacja Game Music", 400], ["PSIEROCINIEC", 440], ["Michał Krajski", 500], ["Łukasz Sakowski // To Tylko Teoria", 525], ["Ośrodek Leczenia i Rehabilitacji Dzikich Zwierząt &#34;Puchaczówka&#34;", 700], ["Radio Wnet", 720], ["Stowarzyszenie na rzecz Chłopców i Mężczyzn", 800], ["Dariusz Rosiak", 1145], ["Radio Nowy Świat", 5892]], 'largest_changes');
            ...
            setTimeout(() => {
                drawMulti(
                    ['pixel', 'teatrzelazny', 'WDWAutomotive', 'outriders', 'krokiet', 'przezswiatnafazie', 'marekczyz', 'fundacjaernesta', 'papierwdole666', 'michalmarszal', 'magda-lassota', 'tzt', 'globstory', 'miloszmiedzyinnymi', 'jagoda-grondecka', 'historyhiking', 'VirtualDream', 'motoambulans', 'TERENWIZJA', 'WspolnotaRTCK'],
