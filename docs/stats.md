...
<script type="text/javascript" src="data/s/synmojegotaty.js"></script>
...
<script type="text/javascript">
    window.onload = () => {
            drawHorizontal([["Radio Nowy Świat", -1105], ["PUNA FAMILY", -975], ["Uwaga Naukowy Bełkot", -831], ["Radio Wnet", -625], ["Kuszlewicz w imieniu", -500], ["Fundacja DAJ HERBATĘ", -420], ["Schronisko Pegasus", -420], ["SciFun", -416], ["Fundacja Primo Elemento", -400], ["Dolnośląski Inspektorat Ochrony Zwierząt", -305], ["SynMojegoTaty", 450], ["Magdalena Czaban", 500], ["Stacja Stela", 505], ["SIEMa Szczecin", 520], ["Zagłębie Sosnowiec Hokej", 600], ["Stowarzyszenie Trójmiejskie Ścieżki MTB", 650], ["Dział Zagraniczny", 680], ["Dariusz Rosiak", 710], ["Profesor Matczak", 885], ["ZAKAZANE HISTORIE", 1020]], 'largest_changes');
            drawMulti(['radio357', 'radionowyswiat', 'radiownet'], 1, 'two_radios', 'currency');
            setTimeout(() => {
                drawMulti(
                    ['DariuszRosiak', 'dzialzagraniczny', 'Podcastwojennehistorie', 'radionaukowe', 'profesor_matczak', 'tetrycy', 'NaukowyBelkot', 'DIOZ', 'WzajemniePomocni', 'marcinzielinski', 'SciFun', 'Fundacja_po_DRUGIE', 'podkastamerykanski', 'Gadowski', 'radioem', 'dajherbate', 'podcastex', 'K3', 'brzmienie-swiata', 'niewiemalesiedowiem'],
