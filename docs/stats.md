...
<script type="text/javascript" src="data/r/rojbers.js"></script>
...
<script type="text/javascript">
    window.onload = () => {
            drawHorizontal([["Marcin Zieliński | Fundacja Rozpal Wiarę", -960], ["Przytulisko Głowno", -580], ["Leszek Korzeniecki", -500], ["Na Wylot", -500], ["OMZRiK", -500], ["Local Girls Movement", -500], ["Teobańkologia", -500], ["Radio Wnet", -445], ["ROJBERS", -445], ["SciFun", -432], ["Fundacja Mały Duży Człowiek", 465], ["SKĄDINĄD. Podcast Tomasza Stawiszyńskiego", 470], ["arhn.eu", 490], ["Fundacja Sztuki Współczesnej In Situ || Sokołowsko", 500], ["Stacja Stela", 611], ["Damian Duda", 725], ["Michał Woroch - w h e e l c h a i r t r i p", 835], ["Szkoła PitagoLasa", 1090], ["Zagłębie Sosnowiec Hokej", 1250], ["Nauka o Klimacie", 1990]], 'largest_changes');
            drawMulti(['radio357', 'radionowyswiat', 'radiownet'], 1, 'two_radios', 'currency');
            setTimeout(() => {
                drawMulti(
                    ['DariuszRosiak', 'dzialzagraniczny', 'Podcastwojennehistorie', 'radionaukowe', 'profesor_matczak', 'tetrycy', 'NaukowyBelkot', 'WzajemniePomocni', 'DIOZ', 'SciFun', 'marcinzielinski', 'Fundacja_po_DRUGIE', 'podkastamerykanski', 'Gadowski', 'radioem', 'dajherbate', 'podcastex', 'K3', 'brzmienie-swiata', 'podcasthistoryczny'],
