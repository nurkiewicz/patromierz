...
<script type="text/javascript">
    window.onload = () => {
            drawHorizontal([["Radio Nowy Świat", -1020], ["PUNA FAMILY", -975], ["Radio Wnet", -895], ["Uwaga Naukowy Bełkot", -777], ["SciFun", -510], ["Fundacja Primo Elemento", -500], ["Kuszlewicz w imieniu", -500], ["Fundacja DAJ HERBATĘ", -465], ["Schronisko Pegasus", -420], ["Niedźwiecka o Zmierzchu", -307], ["SynMojegoTaty", 350], ["Media IronWay + Akademia Triathlonu", 380], ["Dariusz Rosiak", 480], ["SIEMa Szczecin", 500], ["Stacja Stela", 505], ["Dział Zagraniczny", 570], ["Zagłębie Sosnowiec Hokej", 600], ["Stowarzyszenie Trójmiejskie Ścieżki MTB", 650], ["Profesor Matczak", 740], ["ZAKAZANE HISTORIE", 1010]], 'largest_changes');
            drawMulti(['radio357', 'radionowyswiat', 'radiownet'], 1, 'two_radios', 'currency');
            setTimeout(() => {
                drawMulti(
                    ['DariuszRosiak', 'dzialzagraniczny', 'Podcastwojennehistorie', 'radionaukowe', 'profesor_matczak', 'tetrycy', 'NaukowyBelkot', 'WzajemniePomocni', 'DIOZ', 'marcinzielinski', 'SciFun', 'Fundacja_po_DRUGIE', 'podkastamerykanski', 'Gadowski', 'radioem', 'dajherbate', 'podcastex', 'K3', 'brzmienie-swiata', 'podcasthistoryczny'],
